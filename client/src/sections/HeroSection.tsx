...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-pink-100 bg-pink-200/15 hover:cursor-pointer"
            ...
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop wasting time on thumbnail design. Get started with our AI thumbnail generator today! Get eye-catching thumbnails in seconds and boost your video views.
            </motion.p>
