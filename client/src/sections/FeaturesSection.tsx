...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why Choose Us?" text3="Create stunning UIs faster than ever before, just by clicking with X." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Experience the future of thumbnail creation with our AI-powered generator. Say goodbye to tedious design work and hello to stunning, click-worthy thumbnails that drive views and engagement. Try it now and see the difference for yourself!
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Experience the future of thumbnail creation with our AI-powered generator.</p>
